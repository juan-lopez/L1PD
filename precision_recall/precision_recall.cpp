...
int main(int argc, char* argv[])
{
    ...
    DIR="/work/jlopez2/jgonzalez3/semestre_1_25-26/integration_tests/new_files";
    ...
    for (int e = EditStart; e <= EditEnd; e += EditStep)
    {
        ...
        for (int m = MinKmers; m <= MaxKmers; m += 1)
        {
            ...
            executePythonScript(DIR + "/precision_recall_files/filter_possible_sequences.py", pr_dir + "/" + rawfilename + " " + FASTAfile + " -t " + strT + " --data_dir " + DATA_DIR + seqTypeOption + " > " + pr_dir + "/" + filteredfilename, true);           
    ...
    executePythonScript("/work/jlopez2/jgonzalez3/semestre_1_25-26/integration_tests/new_files/precision_recall_files/best_f1.py", " -i " + pr_dir + "/" + to_string(k) + "mers_F1Scores.csv" + " -o " + pr_dir + "/" +  to_string(k) + "mers_best_F1_history.csv" ,true); 
